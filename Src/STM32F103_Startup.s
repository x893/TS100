...
__vector_table
		...
		DCD	 HardFault_Handler		; Hard Fault Handler	+ 0C
		DCD	 MemManage_Handler		; MPU Fault Handler		+ 10
		DCD	 BusFault_Handler		; Bus Fault Handler		+ 14
		DCD	 UsageFault_Handler		; Usage Fault Handler	+ 18
		
		DCD	0						; Reserved				+ 1C
		DCD	0	;//__Dev_SN			; 0x08000020			+ 20
		DCD	0	;//__Ident			; 0x08000024			+ 24
		DCD	0	;//__Chk_SYS		; 0x08000028			+ 28
...
#ifdef DFU_MODE
;	   0x08000100 Start storing the DFU function pointer
;------------------------------
		IMPORT Dev_SN
		EXPORT __Dev_SN
__Dev_SN
